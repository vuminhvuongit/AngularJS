...
public class ProductController {
	...
	@RequestMapping("/product/updateAvailable/{id}/{available}")
	public void updateAvailable(@PathVariable long id, @PathVariable int available) {
		service.updateAvailable(id, available);
	}
